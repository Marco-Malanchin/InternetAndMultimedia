...
class NetworkSlicingTopo(Topo):
    def __init__(self):
        ...
        tcp_link_config = dict(bw=5) #addedo for exercise
        host_link_config = dict()

        # Create switch nodes
        for i in range(5):#changed 4 with 5
        ...
        #add switch links for lab2 exercise
        self.addLink("s1", "s5", **tcp_link_config)
        self.addLink("s5", "s4", **tcp_link_config)
